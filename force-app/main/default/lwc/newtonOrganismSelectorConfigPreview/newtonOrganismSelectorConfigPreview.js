...
import { SAMPLE_ITEMS } from "c/newtonUtilitySelectorDataSources";
import { resolvedLayoutGridConfig } from "c/newtonUtilitySelectorConfigDefaults";
import { buildSobjectConfigForQuery } from "c/newtonUtilitySelectorConfigState";

export default class NewtonOrganismSelectorConfigPreview extends LightningElement {
  @api config;
  @api forcedState = "";
