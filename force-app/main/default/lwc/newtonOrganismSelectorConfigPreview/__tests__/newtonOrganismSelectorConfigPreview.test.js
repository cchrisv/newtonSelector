...
import NewtonOrganismSelectorConfigPreview from "c/newtonOrganismSelectorConfigPreview";
...
function mount(config = FULL_CONFIG, extra = {}) {
  const element = createElement("c-newton-organism-selector-config-preview", {
    is: NewtonOrganismSelectorConfigPreview
  });
...
function getPreviewPicker(element) {
  return element.shadowRoot.querySelector("c-newton-organism-data-selector");
}

describe("c-newton-organism-selector-config-preview", () => {
  afterEach(() => {
