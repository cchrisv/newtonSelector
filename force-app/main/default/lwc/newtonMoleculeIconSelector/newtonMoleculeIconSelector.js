...
export default class NewtonMoleculeIconSelector extends LightningElement {
  @api label = "Icon";
  @api fieldLevelHelp = "";
  @api required = false;
  @api disabled = false;
    ...
    return visible.map((entry) => ({
      ...
      buttonClass:
        entry.iconName === this._value
          ? "newton-icon-cell newton-icon-cell_selected"
          : "newton-icon-cell"
    }));
  }
  ...
  get pickerClass() {
    return this._isOpen
      ? "newton-icon-picker newton-icon-picker_open"
      : "newton-icon-picker";
  }
