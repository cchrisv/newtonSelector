...
export default class NewtonAtomChoiceTile extends LightningElement {
  @api item = {};
  @api variant = VARIANT_GRID;
  @api selected = false;
  @api disabled = false;
  @api selectionMode = MODE_SINGLE;
  @api groupName = "newtonChoiceTile";
  @api size = "medium";
  ...
  get iconWrapClass() {
    return [
      ...
      `newton-choice-tile__icon-wrap_decor-${this.resolvedIconDecor}`,
      `newton-choice-tile__icon-wrap_shape-${this.resolvedIconShapeClass}`,
      `newton-choice-tile__icon-wrap_style-${this.resolvedIconStyle}`,
      `newton-choice-tile__icon-wrap_shading-${this.resolvedIconShading}`,
      `newton-choice-tile__icon-wrap_tone-${this.resolvedIconTone}`,
      `newton-choice-tile__icon-wrap_glyph-${this.resolvedIconGlyphTone}`
    ].join(" ");
  }
  ...
  get badgeClass() {
    return [
      "newton-choice-tile__badge",
      `newton-choice-tile__badge_pos-${this.resolvedBadgePosition}`,
      `newton-choice-tile__badge_variant-${this.resolvedBadgeVariant}`,
      `newton-choice-tile__badge_shape-${this.resolvedBadgeShape}`
    ].join(" ");
  }
  ...
  get wrapperClass() {
    const parts = [
      "newton-choice-tile",
      `newton-choice-tile_${this.resolvedVariant}`,
      `newton-choice-tile_size-${this.resolvedSize}`,
      `newton-choice-tile_aspect-${aspectClassKey(this.resolvedAspect)}`,
      `newton-choice-tile_sel-${this.resolvedSelectionIndicator}`,
      `newton-choice-tile_elev-${this.resolvedElevation}`,
      `newton-choice-tile_pattern-${this.resolvedPattern}`,
      `newton-choice-tile_ptone-${this.resolvedPatternTone}`,
      `newton-choice-tile_phtone-${this.resolvedPatternHoverTone}`,
      `newton-choice-tile_pstone-${this.resolvedPatternSelectedTone}`,
      `newton-choice-tile_pdtone-${this.resolvedPatternDisabledTone}`,
      `newton-choice-tile_corner-${this.resolvedCornerStyle}`,
      `newton-choice-tile_ctone-${this.resolvedCornerTone}`,
      `newton-choice-tile_surface-${this.resolvedSurfaceStyle}`,
      `newton-choice-tile_stone-${this.resolvedSurfaceTone}`,
      `newton-choice-tile_shtone-${this.resolvedSurfaceHoverTone}`,
      `newton-choice-tile_sstone-${this.resolvedSurfaceSelectedTone}`,
      `newton-choice-tile_sdtone-${this.resolvedSurfaceDisabledTone}`
    ];
    if (this.selected) parts.push("newton-choice-tile_selected");
    if (this.isDisabled) parts.push("newton-choice-tile_disabled");
    return parts.join(" ");
  }
