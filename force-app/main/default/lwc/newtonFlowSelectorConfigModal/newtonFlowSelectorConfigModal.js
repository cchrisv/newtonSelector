...
import {
  ...
  totalIssueCount
} from "c/newtonUtilitySelectorConfigValidation";
import { SECTIONS } from "c/newtonUtilitySelectorConfigOptions";

export default class NewtonFlowSelectorConfigModal extends LightningModal {
  @api initialConfig;
