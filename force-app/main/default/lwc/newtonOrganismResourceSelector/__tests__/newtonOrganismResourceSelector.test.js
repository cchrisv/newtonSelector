...
import NewtonOrganismResourceSelector from "c/newtonOrganismResourceSelector";

function mount(props = {}) {
  const el = createElement("c-newton-organism-resource-selector", {
    is: NewtonOrganismResourceSelector
  });
...
describe("c-newton-organism-resource-selector", () => {
  beforeAll(() => {
