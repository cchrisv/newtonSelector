...
import NewtonSelectorFlowCpeCustomLookup from "c/newtonSelectorFlowCpeCustomLookup";

function mount(props = {}) {
  const el = createElement("c-newton-selector-flow-cpe-custom-lookup", {
    is: NewtonSelectorFlowCpeCustomLookup
  });
...
describe("c-newton-selector-flow-cpe-custom-lookup", () => {
  beforeAll(() => {
