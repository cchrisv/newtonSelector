...
import NewtonMoleculeStudioChoiceControl from "c/newtonMoleculeStudioChoiceControl";
...
function mount(overrides = {}) {
  const element = createElement("c-newton-molecule-studio-choice-control", {
    is: NewtonMoleculeStudioChoiceControl
  });
  Object.assign(
    element,
    {
...
describe("c-newton-molecule-studio-choice-control", () => {
  afterEach(() => {
  ...
  it("translates Newton selector selection into a valuechange event", async () => {
    ...
    element.shadowRoot
      .querySelector("c-newton-molecule-selector-group")
      .dispatchEvent(
